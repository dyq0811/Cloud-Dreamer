 ...
 * Modified by Jed Yang, 09 Feb 2017
 */
...
public class WordCloudMaker {
     ...
     */
    public static String getWordCloudHTML(String title, List<TreeWordCountMap.WordCount> wordCountList) {
        // Get the maximum and minimum frequencies for the words in the wordCountList.
        int maximumFrequency = 0;
        int minimumFrequency = Integer.MAX_VALUE;
        for (TreeWordCountMap.WordCount wordCount : wordCountList) {
        ...
        for (int k = wordCountList.size(); k > 1; k--) {
            ...
            TreeWordCountMap.WordCount tempWordCount = wordCountList.get(k - 1);
    ...
    /**
     * Returns an HTML version of the specified TreeWordCountMap.WordCount.
     */
    private static String makeHTMLWord(TreeWordCountMap.WordCount wordCount, int maximumFrequency, int minimumFrequency) {
        ...
        wordString += fontSize + "px;\">&nbsp;";
        wordString += wordCount.getWord() + "&nbsp;</span>\n";
        return wordString;
    }
}
